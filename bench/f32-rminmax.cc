  ...
  benchmark::utils::IsaCheckFunction isa_check = nullptr)
{
  ...
  BENCHMARK_CAPTURE(f32_rminmax, sse_u4,
                    xnn_f32_rminmax_ukernel__sse_u4)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
  ...
  BENCHMARK_CAPTURE(f32_rminmax, neon_u4,
                    xnn_f32_rminmax_ukernel__neon_u4,
                    /*init_params=*/nullptr,
  ...
  BENCHMARK_CAPTURE(f32_rminmax, wasm_u1,
                    xnn_f32_rminmax_ukernel__wasm_u1)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
