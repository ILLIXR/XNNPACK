...
ExecutionPlan FP16SparseMobileNetV3Small(float sparsity, pthreadpool_t threadpool) {
  ...
  std::fill(w104.begin(), w104.end(), 0);
  ...
  std::fill(w106.begin(), w106.end(), 0);
  ...
  std::fill(w108.begin(), w108.end(), 0);
  ...
  std::fill(w110.begin(), w110.end(), 0);
  ...
  std::fill(w114.begin(), w114.end(), 0);
  ...
  std::fill(w116.begin(), w116.end(), 0);
  ...
  std::fill(w122.begin(), w122.end(), 0);
  ...
  std::fill(w128.begin(), w128.end(), 0);
  ...
  std::fill(w170.begin(), w170.end(), 0);
  ...
  std::fill(w176.begin(), w176.end(), 0);
  ...
  std::fill(w182.begin(), w182.end(), 0);
  ...
  std::fill(w188.begin(), w188.end(), 0);
  ...
  std::fill(w198.begin(), w198.end(), 0);
