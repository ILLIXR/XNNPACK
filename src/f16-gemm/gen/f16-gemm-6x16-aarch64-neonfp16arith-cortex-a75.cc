...
// Converted from: src/f16-gemm/gen/f16-gemm-6x16-minmax-asm-aarch64-neonfp16arith-cortex-a75.S
...
xnn_status_t xnn_generate_f16_gemm_ukernel_6x16__aarch64_neonfp16arith_cortex_a75(xnn_code_buffer* code, size_t max_mr, size_t nc_mod_nr, size_t kc, const void* params) {
